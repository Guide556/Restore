...
namespace API.Controllers
{
    public class PaymentsController : BaseApiController
    {
        ...
        public async Task<ActionResult<BasketDto>> CreateOrUpdatePaymentIntent()
        {
            ...
            if (intent == null) return BadRequest(new ProblemDetails { Title = "Problem creatingpayment intent" });
            ...
            if (!result) return BadRequest(new ProblemDetails { Title = "Problem updating basketwith intent" });
